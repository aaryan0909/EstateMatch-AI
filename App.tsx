...
const App: React.FC = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      console.error(err);
      setErrorMsg("Failed to analyze listing. The content might be too long or ambiguous.");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-xs font-bold uppercase tracking-wider px-3 py-1.5 bg-teal-50 text-teal-700 rounded-lg border border-teal-100">
                Canada v2.1
              </span>
            </div>
          </div>
            ...
            <div className="lg:col-span-7 order-1 lg:order-2 space-y-8">
              <div className="bg-white p-8 rounded-3xl shadow-lg border border-stone-100">
                ...
                <p className="text-stone-500 text-lg mb-8 leading-relaxed">
                  Paste a listing URL or content below. We'll analyze strata fees, hidden risks, and 
                  investment potential tailored to your needs.
                </p>
                  ...
                  <div>
                    <div className="relative">
                       <textarea
                        ...
                        placeholder="Paste listing details here (e.g. from Realtor.ca, Zolo, Craigslist)..."
                  ...
                  <button
                    ...
                    className={`w-full py-5 px-6 rounded-2xl font-bold text-lg text-white shadow-lg transition-all 
                      ${appState === AppState.ANALYZING 
                        ...
                        : 'bg-violet-600 hover:bg-violet-700 hover:shadow-xl hover:-translate-y-1'
                      }`}
                  >
                    {appState === AppState.ANALYZING ? (
